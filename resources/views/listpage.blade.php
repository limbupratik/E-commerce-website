         ...
         @foreach($products as $cat)
          <div class="col-10">
            <div class="container">
              ...
              <div class="car mt-5">
                  <div class="left">
                      <img src="{{ $cat->image }}" alt="" witdth="100">
                  </div>
                  <div class="right">
                      <h5>{{ $cat->productname }}</h5>
                      <h4 class="font-weight-bold">${{ $cat->price }} &nbsp;<del class="text-muted ">$11228.00</del></h4>
                      <div class="rating d-flex">
                          ...
                          <p class="pl-3">4.5 <strong class="pl-3 text-info">150 Orders</strong><strong class="pl-3 text-primary">Free shipping</strong></p>
                      </div>
                      <p class="pr-3 text-muted">{{ $cat->feature }}</p>
                      <a href="#">Details</a>
                  </div>
              </div>
          </div>
      ...
      <div class="row d-flex">
          <div class="col-10 mt-4">
            @foreach($products as $cat)
              <div class="car mt-3">
                  <div class="left">
                      <img src="{{asset($cat->images)}}" class="pt-1" alt="" width="100%">
                  </div>
                  <div class="right">
                      <h5>{{$cat->productname}}</h5>
                      <h4 class="font-weight-bold">${{$cat->price}} &nbsp;<del class="text-muted ">$1%</del></h4>
                      <div class="rating d-flex">
                          <div class="icon">
                              <i class="fa fa-star" aria-hidden="true"></i>
                              <i class="fa fa-star" aria-hidden="true"></i>
                          ...
                          <p class="pl-3">3.5 <strong class="pl-3 text-info">150 Orders</strong><strong class="pl-3 text-primary">Free shipping</strong></p>
                      </div>
                      <p class="pr-3 text-muted">{{Str::limit($cat->description, 150)}}<a href="#">Details</a></p>
          ...
          <div class="col-2 border mt-5">
              ...
              <div class="bodycnt">
                  <ul class="ml-0">
                    @php
                    $catagorys=App\Models\Catagory::all();
                    @endphp
                    @foreach($catagories as $cat)
